...
menu += "4. Actualizar todos los datos de una persona a partir de sus datos: <dni>,<nombre>,<apellido1>,<apellido2>,<edad>\n\n";
menu += "5. Buscar datos de personas, según un atributo dado y el valor: <atributo>,<valor>\n";
...
datos_entrada.question("Por favor, seleccione una opción: ",function(opcion)
{
    switch(opcion.toString().trim()) // Convertimos el valor leido a tipo 'String' y borramos los espacios en blanco y saltos de linea
    {
        ...
        case '4':   cadena_aux = "Introduzca los datos de la persona a actualizar (<dni>,<nombre>,<apellido1>,<apellido2>,<edad>): ";
        ...
        case '5':   cadena_aux = "Introduzca el criterio y el valor de búsqueda (<atributo>,<valor>): ";
