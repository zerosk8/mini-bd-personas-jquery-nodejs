 ...
 * 
 * 4. Actualizar todos los datos de una persona con la operacion POST y sus datos: '/persona/<dni>/<nombre>/<apellido1>/<apellido2>/<edad>'
 * 
...
var PAGINA_INICIO = 'cliente.html';
...
app.post('/persona/:dni/:nombre/:apellido1/:apellido2/:edad',function(req,res)
{
    ...
    if(req.params.dni in personas)
    {
        ...
        personas[req.params.dni].apellido1 = req.params.apellido1;
